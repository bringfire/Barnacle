...
#define BLUEFRUIT_UART_CTS_PIN         A2   // Required for software serial!
#define BLUEFRUIT_UART_RTS_PIN         A3   // Optional, set to -1 if unused
...
// ----------------------------------------------------------------------------------------------
#define BLUEFRUIT_UART_MODE_PIN        A6    // Set to -1 if unused
